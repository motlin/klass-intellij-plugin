...
dependencies {
    ...
    rewrite("org.openrewrite.recipe:rewrite-migrate-java:3.35.2")
    rewrite("org.openrewrite.recipe:rewrite-testing-frameworks:3.35.2")
    rewrite("org.openrewrite.recipe:rewrite-logging-frameworks:3.27.2")
}
