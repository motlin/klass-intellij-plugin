...
public class KlassBlock extends AbstractBlock {
	...
	private Alignment getAlignment(IElementType elementType) {
		...
		if (
			parentElementType == KlassTypes.PRIMITIVE_TYPE_PROPERTY
		...
		if (
			parentElementType == KlassTypes.PROJECTION
	...
	public Indent getIndent() {
		...
		if (elementType == KlassTokenType.END_OF_LINE_COMMENT || elementType == KlassTokenType.C_STYLE_COMMENT) {
