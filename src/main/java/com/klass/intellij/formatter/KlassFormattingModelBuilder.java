...
public class KlassFormattingModelBuilder implements FormattingModelBuilder {
	...
	public static final TokenSet ONE_SPACE_AROUND = TokenSet.create(KlassTypes.OPERATOR, KlassTypes.ON_KEYWORD);
	...
	private static SpacingBuilder createSpaceBuilder(CodeStyleSettings settings) {
		...
		SpacingBuilder spacingBuilder = new SpacingBuilder(settings, KlassLanguage.INSTANCE)
			...
			.none()
			.after(TokenSet.create(KlassTokenType.END_OF_LINE_COMMENT, KlassTypes.LBRACE, KlassTypes.L_BRACE))
			.lineBreakInCode()
