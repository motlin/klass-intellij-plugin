...
public class KlassFormattingModelBuilder implements FormattingModelBuilder {
  public static final TokenSet NONE_BEFORE =
      TokenSet.create(
  ...
  public static final TokenSet NONE_AROUND =
      TokenSet.create(
          KlassTypes.URL_CONSTANT,
          KlassTypes.URL_IDENTIFIER,
          KlassTypes.URL_PART,
          KlassTypes.DOT,
          KlassTypes.DOTDOT,
          KlassTypes.LBRACKET,
          KlassTypes.LPAREN);
  public static final TokenSet NONE_INSIDE =
      TokenSet.create(
          KlassTypes.URL, KlassTypes.URL_PART, KlassTypes.QUERY_PARAM_PART, KlassTypes.NOMBRE);

  public static final TokenSet BLANK_LINE_BEFORE =
      TokenSet.create(KlassTypes.RELATIONSHIP, KlassTokenType.END_OF_LINE_COMMENT);
  public static final TokenSet BLANK_LINE_AROUND =
      TokenSet.create(
  ...
  public static final TokenSet LINE_BREAK_BEFORE =
      TokenSet.create(
          KlassTypes.ANDAND,
          KlassTypes.OROR,
  ...
  public static final TokenSet LINE_BREAK_AFTER =
      TokenSet.create(KlassTypes.COMMA, KlassTokenType.END_OF_LINE_COMMENT);

  public static final TokenSet ONE_SPACE_BEFORE =
      TokenSet.create(
          KlassTypes.NOMBRE,
  ...
  public static final TokenSet ONE_SPACE_AFTER =
      TokenSet.create(
          KlassTypes.COLON,
          KlassTypes.ANDAND,
          KlassTypes.OROR,
  ...
  public static final TokenSet ONE_SPACE_AROUND =
      TokenSet.create(KlassTypes.OPERATOR, KlassTypes.ON_KEYWORD);
  public static final TokenSet BRACES =
      TokenSet.create(KlassTypes.LBRACE, KlassTypes.RBRACE, KlassTypes.L_BRACE, KlassTypes.R_BRACE);
  public static final TokenSet LINE_BREAK_AROUND_HIGH_PRIORITY =
      TokenSet.create(
  ...
  public static final TokenSet LINE_BREAK_AROUND =
      TokenSet.create(
  ...
  public static final TokenSet INDENT_CHILDREN =
      TokenSet.create(
          KlassTypes.INTERFACE,
          KlassTypes.KLASS,
          KlassTypes.ASSOCIATION,
  ...
  @Nullable private Indent getChildIndent(PsiElement element) {
  ...
  private static SpacingBuilder createSpaceBuilder(CodeStyleSettings settings) {
    ...
    SpacingBuilder spacingBuilder =
        new SpacingBuilder(settings, KlassLanguage.INSTANCE)
            .before(NONE_BEFORE)
            .none()
            .around(NONE_AROUND)
            .none()
            .aroundInside(TokenSet.ANY, NONE_INSIDE)
            .none()
            .after(
                TokenSet.create(
                    KlassTokenType.END_OF_LINE_COMMENT, KlassTypes.LBRACE, KlassTypes.L_BRACE))
            .lineBreakInCode()
            .before(TokenSet.create(KlassTypes.RBRACE, KlassTypes.R_BRACE))
            .lineBreakInCode()
            .around(BLANK_LINE_AROUND)
            .blankLines(1)
            .before(BLANK_LINE_BEFORE)
            .blankLines(1)
            .before(LINE_BREAK_BEFORE)
            .lineBreakInCode()
            .afterInside(KlassTypes.COMMA, KlassTypes.EXPRESSION_LITERALS)
            .spaces(1)
            .after(LINE_BREAK_AFTER)
            .lineBreakInCode()
            .around(BRACES)
            .lineBreakInCode()
            .around(LINE_BREAK_AROUND_HIGH_PRIORITY)
            .lineBreakInCode()
            .before(KlassTokenType.END_OF_LINE_COMMENT)
            .blankLines(1)
            .around(KlassTypes.PARAMETERIZED_PROPERTY)
            .blankLines(1)
            .around(LINE_BREAK_AROUND)
            .lineBreakInCode()
            .before(ONE_SPACE_BEFORE)
            .spaces(1)
            .after(ONE_SPACE_AFTER)
            .spaces(1)
            .around(ONE_SPACE_AROUND)
            .spaces(1);
