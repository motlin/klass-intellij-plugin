...
public interface TokenSets {
  ...
  TokenSet OPERATION_BIT_SET =
      TokenSet.create(
          ...
          OROR,
          PERCENT,
          /*EQ, GT, LT, EXCL, TILDE,*/ QUESTION_MARK,
          COLON /*, PLUS, MINUS, ASTERISK, DIV, AND, OR, XOR,
  ...
  // ABSTRACT_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD,
  //            SYNCHRONIZED_KEYWORD, STRICTFP_KEYWORD, TRANSIENT_KEYWORD, VOLATILE_KEYWORD,
  // DEFAULT_KEYWORD);
  //
  ...
  //            CLASS_OBJECT_ACCESS_EXPRESSION, METHOD_REF_EXPRESSION, LAMBDA_EXPRESSION,
  // EMPTY_EXPRESSION);
  //
  ...
  // POLYADIC_EXPRESSION, CONDITIONAL_EXPRESSION,
  //            ASSIGNMENT_EXPRESSION, NEW_EXPRESSION, ARRAY_ACCESS_EXPRESSION,
  // INSTANCE_OF_EXPRESSION, CLASS_OBJECT_ACCESS_EXPRESSION,
  //            EMPTY_EXPRESSION);
  //
  ...
  //            REQUIRES_STATEMENT, EXPORTS_STATEMENT, OPENS_STATEMENT, USES_STATEMENT,
  // PROVIDES_STATEMENT);
  //
  ...
  TokenSet MEMBER_BIT_SET =
      TokenSet.create(KLASS, ASSOCIATION /*, FIELD, ENUM_CONSTANT, METHOD, ANNOTATION_METHOD*/);
