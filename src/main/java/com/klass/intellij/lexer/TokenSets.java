...
public final class TokenSets {
	...
	public static final TokenSet KLASS_PLAIN_COMMENT_BIT_SET = TokenSet.create(END_OF_LINE_COMMENT, C_STYLE_COMMENT);

	public static final TokenSet KLASS_COMMENT_OR_WHITESPACE_BIT_SET = TokenSet.orSet(
		KLASS_WHITESPACE_BIT_SET,
		KLASS_PLAIN_COMMENT_BIT_SET
	);
	...
	public static final TokenSet LITERAL_BIT_SET = TokenSet.create(TRUE_KEYWORD, FALSE_KEYWORD, NULL_KEYWORD);
	...
	public static final TokenSet KEYWORD_OPERATION_BIT_SET = TokenSet.create(
		CONTAINS_OPERATOR,
	...
	public static final TokenSet PRIMITIVE_TYPE_BIT_SET = TokenSet.create(
		ID_MODIFIER,
		BOOLEAN_KEYWORD,
		INTEGER_KEYWORD,
		LONG_KEYWORD,
	...
	public static final TokenSet CLASS_KEYWORD_BIT_SET = TokenSet.create(CLASS_KEYWORD, ASSOCIATION_KEYWORD);
