...
public class KlassRefactoringSupportProvider extends RefactoringSupportProvider {
  ...
  public static boolean mayRenameInplace(
      PsiElement elementToRename, PsiElement nameSuggestionContext) {
    ...
    SearchScope useScope =
        PsiSearchHelper.SERVICE
            .getInstance(elementToRename.getProject())
            .getUseScope(elementToRename);
