...
public class KlassStructureViewElement implements StructureViewTreeElement {
	...
	public ItemPresentation getPresentation() {
		...
		if (this.element instanceof KlassParameterizedPropertySignature parameterizedPropertySignature) {
	...
	public TreeElement[] getChildren() {
		if (this.element instanceof KlassFile) {
			...
			return Arrays.stream(childrenOfType).map(KlassStructureViewElement::new).toArray(TreeElement[]::new);
		}
