...
public class KlassElementFactory {
  ...
  public static KlassFile createFile(Project project, String text) {
    ...
    return (KlassFile)
        PsiFileFactory.getInstance(project).createFileFromText(name, KlassFileType.INSTANCE, text);
  }
  ...
  public static KlassPrimitiveTypeProperty createPrimitiveTypeProperty(
    ...
    KlassFile file =
        KlassElementFactory.createFile(
            ...
            "package dummy\n"
                ...
                + "}\n");
    KlassKlass klassKlass = file.findChildByClass(KlassKlass.class);
    return (KlassEnumerationProperty)
        klassKlass.getClassBlock().getClassBody().getMemberList().get(0);
  }

  public static KlassParameterizedProperty createParameterizedProperty(
      Project project, String name) {
    KlassFile file =
        KlassElementFactory.createFile(
            project,
            "package dummy\n"
                ...
                + "}\n");
    KlassKlass klassKlass = file.findChildByClass(KlassKlass.class);
    return (KlassParameterizedProperty)
        klassKlass.getClassBlock().getClassBody().getMemberList().get(0);
  }
  ...
  public static KlassParameterizedPropertySignature createParameterizedPropertySignature(
    ...
    return (KlassParameterizedPropertySignature)
        klassInterface.getInterfaceBlock().getInterfaceBody().getMemberList().get(0);
  }
  ...
  public static KlassAssociationEndSignature createAssociationEndSignature(
      Project project, String name) {
    KlassFile file =
        KlassElementFactory.createFile(
            project,
            "package dummy\n"
                ...
                + "}\n");
    KlassInterface klassInterface = file.findChildByClass(KlassInterface.class);
    return (KlassAssociationEndSignature)
        klassInterface.getInterfaceBlock().getInterfaceBody().getMemberList().get(0);
  }
  ...
  public static KlassMemberName createPropertyName(Project project, String newElementName) {
    ...
    KlassProjectionLeafNode projectionLeafNode =
        (KlassProjectionLeafNode)
            klassProjection.getProjectionBlock().getProjectionBody().getProjectionNodeList().get(0);
    ...
    KlassFile file =
        KlassElementFactory.createFile(
            ...
            "package dummy\n"
                ...
                + "}\n");
    KlassKlass klassKlass = file.findChildByClass(KlassKlass.class);
    KlassEnumerationProperty klassEnumerationProperty =
        (KlassEnumerationProperty) klassKlass.getClassBlock().getClassBody().getMemberList().get(0);
  ...
  public static KlassAssociationEndName createAssociationEndName(
      Project project, String newElementName) {
    KlassFile file =
        KlassElementFactory.createFile(
            project,
            "package dummy\n"
                ...
                + "}\n");
    KlassProjection klassProjection = file.findChildByClass(KlassProjection.class);
    return ((KlassProjectionAssociationEndNode)
            klassProjection.getProjectionBlock().getProjectionBody().getProjectionNodeList().get(0))
    ...
    KlassFile file =
        KlassElementFactory.createFile(
            ...
            "package dummy\n"
                ...
                + "}\n");
    KlassProjection klassProjection = file.findChildByClass(KlassProjection.class);
    return ((KlassProjectionParameterizedPropertyNode)
            klassProjection.getProjectionBlock().getProjectionBody().getProjectionNodeList().get(0))
    ...
    KlassFile file =
        KlassElementFactory.createFile(
            ...
            "package dummy\n"
                ...
                + "}\n");
    KlassProjection klassProjection = file.findChildByClass(KlassProjection.class);
    KlassProjectionNode klassProjectionNode =
        klassProjection.getProjectionBlock().getProjectionBody().getProjectionNodeList().get(0);
  ...
  public static KlassExpressionVariableName createExpressionVariableName(
      Project project, String newElementName) {
    KlassFile file =
        KlassElementFactory.createFile(
            project,
    ...
    return (KlassExpressionVariableName)
