...
public final class KlassHighlightingColors {
	...
	public static final TextAttributesKey KLASS_BLOCK_COMMENT = createTextAttributesKey(
		"KLASS_BLOCK_COMMENT",
		BLOCK_COMMENT
	);
	...
	public static final TextAttributesKey KLASS_SEMICOLON = createTextAttributesKey("KLASS_SEMICOLON", SEMICOLON);
	...
	public static final TextAttributesKey VALID_STRING_ESCAPE = createTextAttributesKey(
		"KLASS_VALID_STRING_ESCAPE",
		DefaultLanguageHighlighterColors.VALID_STRING_ESCAPE
	);
	public static final TextAttributesKey INVALID_STRING_ESCAPE = createTextAttributesKey(
		"KLASS_INVALID_STRING_ESCAPE",
		DefaultLanguageHighlighterColors.INVALID_STRING_ESCAPE
	);

	public static final TextAttributesKey LOCAL_VARIABLE_ATTRIBUTES = createTextAttributesKey(
		"LOCAL_VARIABLE_ATTRIBUTES",
		LOCAL_VARIABLE
	);
	public static final TextAttributesKey PARAMETER_ATTRIBUTES = createTextAttributesKey(
		"PARAMETER_ATTRIBUTES",
		PARAMETER
	);
	public static final TextAttributesKey INSTANCE_FIELD_ATTRIBUTES = createTextAttributesKey(
		"INSTANCE_FIELD_ATTRIBUTES",
		INSTANCE_FIELD
	);
	public static final TextAttributesKey INSTANCE_FINAL_FIELD_ATTRIBUTES = createTextAttributesKey(
		"INSTANCE_FINAL_FIELD_ATTRIBUTES",
		INSTANCE_FIELD_ATTRIBUTES
	);
	public static final TextAttributesKey STATIC_FIELD_ATTRIBUTES = createTextAttributesKey(
		"STATIC_FIELD_ATTRIBUTES",
		STATIC_FIELD
	);
	public static final TextAttributesKey STATIC_FINAL_FIELD_ATTRIBUTES = createTextAttributesKey(
		"STATIC_FINAL_FIELD_ATTRIBUTES",
		STATIC_FIELD_ATTRIBUTES
	);
	public static final TextAttributesKey CLASS_NAME_ATTRIBUTES = createTextAttributesKey(
		"CLASS_NAME_ATTRIBUTES",
		CLASS_NAME
	);
	public static final TextAttributesKey PROJECTION_NAME_ATTRIBUTES = createTextAttributesKey(
		"PROJECTION_NAME_ATTRIBUTES",
		CLASS_NAME
	);
	public static final TextAttributesKey ENUM_NAME_ATTRIBUTES = createTextAttributesKey(
		"ENUM_NAME_ATTRIBUTES",
		CLASS_NAME_ATTRIBUTES
	);
	public static final TextAttributesKey ENUM_LITERAL_ATTRIBUTES = createTextAttributesKey(
		"ENUM_LITERAL_ATTRIBUTES",
		CONSTANT
	);
