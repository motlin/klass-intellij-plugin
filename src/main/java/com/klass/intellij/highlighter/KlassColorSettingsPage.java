...
public class KlassColorSettingsPage implements ColorSettingsPage, DisplayPrioritySortable {
  @NonNls
  private static final Map<String, TextAttributesKey> OUR_TAGS =
  ...
  private static final AttributesDescriptor[] DESCRIPTORS = {
    ...
    new AttributesDescriptor(
        "Enumeration literal", KlassHighlightingColors.ENUM_LITERAL_ATTRIBUTES),
    ...
    new AttributesDescriptor(
        "Property name", KlassHighlightingColors.INSTANCE_FINAL_FIELD_ATTRIBUTES),
    new AttributesDescriptor(
        "Service path parameter", KlassHighlightingColors.PARAMETER_ATTRIBUTES),
