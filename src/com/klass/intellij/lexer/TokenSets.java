...
public interface TokenSets
{
    ...
    TokenSet KEYWORD_BIT_SET =
            TokenSet.create(ASSOCIATION_KEYWORD, CLASS_KEYWORD, ENUMERATION_KEYWORD, PROJECTION_KEYWORD, SERVICE_KEYWORD, VALID_TEMPORAL_KEYWORD, SYSTEM_TEMPORAL_KEYWORD, BITEMPORAL_KEYWORD, VERSIONED_KEYWORD, KEY_KEYWORD, CRITERIA_KEYWORD, MULTIPLICITY_KEYWORD, ONE_KEYWORD, MANY_KEYWORD, THIS_KEYWORD);
