...
public interface TokenSets
{
    ...
    TokenSet KEYWORD_BIT_SET =
            TokenSet.create(ASSOCIATION_KEYWORD, CLASS_KEYWORD, ENUMERATION_KEYWORD, PROJECTION_KEYWORD, SERVICE_KEYWORD, USER_KEYWORD, VALID_TEMPORAL_KEYWORD, SYSTEM_TEMPORAL_KEYWORD, BITEMPORAL_KEYWORD, VERSIONED_KEYWORD, AUDITED_KEYWORD, KEY_KEYWORD, CRITERIA_KEYWORD, MULTIPLICITY_KEYWORD, ONE_KEYWORD, MANY_KEYWORD, THIS_KEYWORD, ON_KEYWORD);
    ...
    TokenSet PRIMITIVE_TYPE_BIT_SET = TokenSet.create(
            ID_KEYWORD, BOOLEAN_KEYWORD, INTEGER_KEYWORD, LONG_KEYWORD, FLOAT_KEYWORD, DOUBLE_KEYWORD, STRING_KEYWORD, INSTANT_KEYWORD, LOCAL_DATE_KEYWORD);
