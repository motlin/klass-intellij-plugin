...
public interface KlassTokenType extends TokenType
{
    ...
    IElementType ASSOCIATION_KEYWORD = new IKeywordElementType("ASSOCIATION_KEYWORD");
    IElementType PROJECTION_KEYWORD = new IKeywordElementType("PROJECTION _KEYWORD");
    IElementType ENUMERATION_KEYWORD = new IKeywordElementType("ENUMERATION _KEYWORD");
    ...
    IElementType DOTDOT = new IJavaElementType("DOTDOT");
