...
public class KlassRenameTest extends BasePlatformTestCase {
	...
	public void testRenameClassFromReference() {
		myFixture.testRename("RenameClassFromReferenceBefore.klass", "RenameClassFromReferenceAfter.klass", "Person");
	}

	public void testRenameInterfaceDeclaration() {
		myFixture.testRename("RenameInterfaceBefore.klass", "RenameInterfaceAfter.klass", "Identifiable");
	}
	...
	public void testRenameAssociationDeclaration() {
		myFixture.testRename("RenameAssociationBefore.klass", "RenameAssociationAfter.klass", "UserRole");
	}

	public void testRenameMemberProperty() {
		myFixture.testRename("RenameMemberPropertyBefore.klass", "RenameMemberPropertyAfter.klass", "fullName");
	}

	public void testRenameEnumerationLiteral() {
		myFixture.testRename("RenameEnumerationLiteralBefore.klass", "RenameEnumerationLiteralAfter.klass", "ENABLED");
	}
